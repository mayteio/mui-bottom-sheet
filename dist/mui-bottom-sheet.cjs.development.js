...
var defaultOptions = {
  ...
  hidden: false,
  peekHeights: [],
  springConfig: reactSpring.config.stiff,
  styles: {
    root: {},
    backdrop: {},
    background: {}
...
var BottomSheet = function BottomSheet(props) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(reactSpring.a.div, Object.assign({}, bind(), {
    ...
    ref: measureRef
  }, props.children)), background && React__default.createElement(reactSpring.a.div, {
    style: _extends({}, styles.background, {}, userStyles.background, {}, backgroundStyle),
    className: "background"
  }, background), React__default.createElement(reactSpring.a.div, {
...
//# sourceMappingURL=mui-bottom-sheet.cjs.development.js.map
